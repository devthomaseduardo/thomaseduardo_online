...
const translations = {
  pt: {
    ...
    hero: {
      ...
      h1a: "DO CÓDIGO",
      h1b: "AO RESULTADO REAL.",
      desc: "Arquitetura técnica com visão estratégica de produto. Transformo ideias em ativos digitais de alta performance que impulsionam o crescimento real do seu negócio.",
      ctaProjects: "VER CASES",
      ctaContact: "CONSULTORIA GRATUITA",
    },
    stats: {
  ...
  en: {
    ...
    hero: {
      ...
      h1a: "FROM CODE",
      h1b: "TO REAL RESULTS.",
      desc: "Technical architecture with strategic product vision. I transform ideas into high-performance digital assets that drive real business growth.",
