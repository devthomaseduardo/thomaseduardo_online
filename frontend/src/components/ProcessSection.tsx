  ...
  return (
    <section id="processo" className="relative section-padding px-6 bg-pg-bg overflow-hidden">
      <div className="w-full px-6 md:px-16 lg:px-24 mx-auto relative z-10">
        <motion.div {...FADE_UP} className="mb-16 flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div>
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 w-full">
          {TAB_CONTENT.map((tab: any, index: number) => (
            ...
            >
              ...
              <div className="bg-neutral-900/80 backdrop-blur-md border border-white/10 rounded-b-2xl rounded-tr-2xl p-6 relative z-0 group-hover:border-white/20 transition-colors min-h-[180px] flex flex-col shadow-2xl group-hover:bg-neutral-800/80">
                ...
                <h3 className="text-2xl md:text-3xl font-bold tracking-tight text-white mb-4 mt-2">
                  {tab.title}
                </h3>
