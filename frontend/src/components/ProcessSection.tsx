...
export const ProcessSection = () => {
  ...
  return (
    <section id="processo" className="relative section-padding px-6 bg-pg-bg overflow-hidden">
      <div className="w-full px-6 md:px-16 lg:px-24 mx-auto relative z-10">
        <motion.div {...FADE_UP} className="mb-8 md:mb-16 flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div>
        ...
        <div className="mt-4 md:mt-16 flex md:grid md:grid-cols-3 gap-4 md:gap-6 lg:gap-12 w-[calc(100%+3rem)] -mx-6 px-6 md:w-full md:mx-0 md:px-0 overflow-x-auto snap-x snap-mandatory pb-8 md:pb-0 no-scrollbar scroll-px-6">
